            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp bold uppercase">Quản lý danh sách bữa ăn</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    ...
                    <form id="form" action="<?php echo base_url(); ?>tourattributemeal/delete" method="post">
                    <div id="table">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                            ...
                            <?php if($list) {
                                ...
                                <tr class="gradeX <?php if($key%2==0){echo 'odd active';}else{echo 'even active';} ?>" role="row">
                                    <td>
                                        <input type="checkbox" id="check"  name="case[]" value="<?php echo $value['attribute_meal_id']; ?>">
                                    </td>
                                    <td><?php echo $value['name']; ?></td>
                                    <td><?php echo $value['sort_order']; ?></td>
                                    <td style="text-align: center;">
                                        <a href="<?php echo site_url('tourattributemeal'); ?>/edit/<?php echo $value['attribute_meal_id']; ?>">Sửa <i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                <?php }}else{?>
                                <tr>
...
<script type="text/javascript">
    ...
    $('#btnAdd').on('click',function(){
        location = '<?php echo base_url(); ?>tourattributemeal/create';
    });
    $('#search').on('input',function(){
        $.ajax({
            url: '<?php echo base_url(); ?>tourattributemeal/search',
            type: 'post',
            dataType: 'html',
