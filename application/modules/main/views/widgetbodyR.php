...
<div class="portlet light bordered">
   ...
   <div class="portlet-body" id="chats">
      <div  style="position: relative; overflow: hidden; width: auto; height: 220px;">
         <div class="scroller" style="height: 330px;" data-always-visible="1" data-rail-visible="0" data-handle-color="#FF0000">
            <ul class="chats">
               <li class="out">
