                    ...
                    <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="search" id="search" class="form-control input-inline" placeholder="" aria-controls="sample_1">
                            </div>
                        </div>
                    </div>
                    <form id="form" action="<?php echo base_url(); ?>users/delete" method="post">
                    <div id="table">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                            ...
                            <tbody>
                                <tr class="filter">
						            ...
						            <td><input type="text" name="filter_group" value="<?php if(isset($filter['group'])){echo $filter['group'];} ?>" style="width:100%;" /></td>
                                    <td style="width:7%;"></td>
					            </tr>
                            <?php if($list) {
                                ...
                                <tr class="gradeX <?php if($key%2==0){echo 'odd active';}else{echo 'even active';} ?>" role="row">
                                    <td>
                                        <input type="checkbox" id="check"  name="case[]" value="<?php echo $value['user_id']; ?>">
                                    </td>
                                    <td><?php echo $value['username']; ?></td>
                                    <td><?php echo $value['namegroup']; ?></td>
                                    <td style="text-align: center;">
                                        <a href="<?php echo site_url('users'); ?>/edit/<?php echo $value['user_id']; ?>">Sửa <i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                <?php }}else{?>
                                <tr>
...
<script type="text/javascript">
    ...
    $('#btnAdd').on('click',function(){
        location = '<?php echo base_url(); ?>users/create';
    });
    ...
    function loaddatatable(){
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data:{filter_row:table_row_length,filter_name:filter_name,filter_group:filter_group},
            success: function(results) {
