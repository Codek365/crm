...
class Mpolicy extends CI_Model{
	...
	protected $_policy_description = "policy_description";

	public function __construct() {
        parent::__construct();
    }
    public function getAllPolicy(){
    	$this->db->join($this->_policy_description,$this->_policy.'.policy_id='.$this->_policy_description.'.policy_id');
    	$this->db->order_by('sort_order','ASC');
    	$query = $this->db->get($this->_policy);
